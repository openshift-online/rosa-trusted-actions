...
func TestSQLiteStore_ListExecutions_NoFilter(t *testing.T) {
	...
	s.CreateExecution(ctx, exec1)
	s.CreateExecution(ctx, exec2)
...
func TestSQLiteStore_ListExecutions_FilterByAction(t *testing.T) {
	...
	s.CreateExecution(ctx, testExecution("cluster-info", "cluster-1"))
	s.CreateExecution(ctx, testExecution("pod-restart", "cluster-2"))
...
func TestSQLiteStore_ListAuditEntries_FilterByAction(t *testing.T) {
	...
	s.CreateAuditEntry(ctx, &models.AuditEntry{
