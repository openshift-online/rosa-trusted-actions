CREATE TABLE IF NOT EXISTS audit_entries_old (
    id              TEXT PRIMARY KEY,
...
INSERT INTO audit_entries_old SELECT * FROM audit_entries;

DROP TABLE audit_entries;

ALTER TABLE audit_entries_old RENAME TO audit_entries;
